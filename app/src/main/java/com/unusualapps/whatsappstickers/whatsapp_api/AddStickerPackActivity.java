                ...
                if (data != null) {
                    ...
                    if (validationError != null) {
                        if (BuildConfig.DEBUG) {
                            //el error de validación debe mostrarse solo al desarrollador, no a los usuarios.
                            MessageDialogFragment.newInstance(R.string.title_validation_error, validationError).show(getSupportFragmentManager(), "error de validación");
                        }
                        Log.e("AddStickerPackActivity", "Validation failed:" + validationError);
                    }
                } else {
                    new StickerPackNotAddedMessageFragment().show(getSupportFragmentManager(), "sticker pack no añadido");
                }
            }
        }
    }
