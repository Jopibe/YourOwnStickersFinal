...
public class WhitelistCheck {
    private static final String AUTHORITY_QUERY_PARAM = "autoridad";
    private static final String IDENTIFIER_QUERY_PARAM = "identificador";
    ...
    private static boolean isWhitelistedFromProvider(@NonNull Context context, @NonNull String identifier, String whatsappPackageName) {
        ...
        if (isPackageInstalled(whatsappPackageName, packageManager)) {
            ...
            //Si la aplicación no está instalada, entonces no es necesario tener en cuenta la información de su whitelist.
            return true;
        }
        return false;
    }
